/*
This Code still contains Serial Prints for debug reasons
It works just like the other just with additional Serial Prints when buttons are pressed.
Use the non debug code for use on the XDJ100sx due to update reasons. This code will probably not be updated in the future
